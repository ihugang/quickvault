...
private let authLogger = Logger(subsystem: AppConstants.Logger.subsystem, category: AppConstants.Logger.Category.auth)
...
public enum AuthenticationError: LocalizedError {
  ...
  public var localizationKey: String {
    ...
    case .biometricNotAvailable:
      return LocalizationKeys.Auth.Error.biometricUnavailable
    case .biometricFailed:
      return LocalizationKeys.Auth.Error.biometricFailed
    case .biometricPasswordNotStored:
      return LocalizationKeys.Auth.Error.biometricPasswordNotStored
    case .passwordIncorrect:
      return LocalizationKeys.Auth.Error.passwordIncorrect
    case .passwordTooShort:
      return LocalizationKeys.Auth.Error.passwordTooShort
    case .noPasswordSet:
      return LocalizationKeys.Auth.Error.noPassword
    case .rateLimited:
      return LocalizationKeys.Auth.Error.rateLimited
    case .keychainError:
      return LocalizationKeys.Auth.Error.keychain
    }
  }
...
public class AuthenticationServiceImpl: AuthenticationService {
  ...
  private let masterPasswordKey = AppConstants.Keychain.masterPasswordKey
  private let biometricPasswordKey = AppConstants.Keychain.biometricPasswordKey
  private let biometricEnabledKey = AppConstants.UserDefaultsKeys.biometricEnabled
  private let failedAttemptsKey = AppConstants.UserDefaultsKeys.failedAttempts
  private let lastFailedAttemptKey = AppConstants.UserDefaultsKeys.lastFailedAttempt

  private let maxFailedAttempts = AppConstants.RateLimit.maxFailedAttempts
  private let rateLimitDuration = AppConstants.RateLimit.lockoutDuration
